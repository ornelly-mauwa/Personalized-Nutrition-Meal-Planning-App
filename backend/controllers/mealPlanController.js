...
class MealPlanController {
     ...
     * @param {Function} next - Express next middleware function
     */
    async getUserMealPlans(req, res, next) {
        try {
     ...
     * @param {Function} next - Express next middleware function
     */
    async getNutritionistMealPlans(req, res, next) {
        try {
     ...
     * @param {Function} next - Express next middleware function
     */
    async addMealsToPlan(req, res, next) {
        try {
            const { role, userId } = req.user;
            const { id } = req.params;
     ...
     * @param {Function} next - Express next middleware function
     */
    async getRecommendedMealPlans(req, res, next) {
        try {
            const { userId } = req.user;
